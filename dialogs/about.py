...
def show():
    ...
    app_icon = tk.Canvas(app_info, width = preferences.get_scaled_value(63), height = preferences.get_scaled_value(40), highlightthickness = 0, background = custom_ui.bg)
    app_icon.pack(side = "left", padx = (0, preferences.get_scaled_value(16)), pady = (preferences.get_scaled_value(16), 0))
    app_icon.create_image(preferences.get_scaled_value(63) // 2, preferences.get_scaled_value(40) // 2, image = custom_ui.ic_app_about, anchor = "center")
